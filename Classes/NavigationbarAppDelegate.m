...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	cityController.title =@"旅游指南";
		...
		//add a ButtonItem
	UIBarButtonItem *buttonItem = [[UIBarButtonItem alloc] initWithTitle:@"All City" 
																   style:UIBarButtonItemStyleBordered target:nil action:nil];
	cityController.navigationItem.backBarButtonItem = buttonItem;
	[buttonItem release];
	
	[navController pushViewController:cityController animated:YES];
